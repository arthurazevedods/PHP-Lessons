...
<head>
    ...
    <title>5. Functions and Filters</title>
</head>
<body>
<div class="arrays">
        <?php 
            ...
            function filteredByAuthors($books) {
                $filteredBooks = [];
        ...
        ?>
        <h2>Recommend Cities</h2>
        <ul>
            <?php foreach ($cities as $city): ?>
                <?php if($city['country']==='Japan'):?>
                    <li>
                        <?php echo $city["name"]; ?>
        ...
        <ul>
        <?php foreach (filteredByAuthors($books) as $book): ?>
                <li>
